...
import cn.vove7.common.datamanager.greendao.CommandHistoryDao;
...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig commandHistoryDaoConfig;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        commandHistoryDaoConfig = daoConfigMap.get(CommandHistoryDao.class).clone();
        commandHistoryDaoConfig.initIdentityScope(type);
        ...
        commandHistoryDao = new CommandHistoryDao(commandHistoryDaoConfig, this);
        ...
        registerDao(CommandHistory.class, commandHistoryDao);
    ...
    public void clear() {
        ...
        commandHistoryDaoConfig.clearIdentityScope();
    ...
    public CommandHistoryDao getCommandHistoryDao() {
        return commandHistoryDao;
    }
