...
import com.qihoo360.replugin.PluginDexClassLoaderPatch;
...
public class MyPluginDexClassLoader extends PluginDexClassLoader {

    private static final String TAG = "MyPluginDexClassLoader";
     ...
     */
    public MyPluginDexClassLoader(PluginInfo pi, String dexPath, String optimizedDirectory, String librarySearchPath, ClassLoader parent) {
