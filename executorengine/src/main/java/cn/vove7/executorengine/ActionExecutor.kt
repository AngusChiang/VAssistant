...
class ActionExecutor(
...
) : ExecutorImpl(context, getAccessibilityBridge, systemBridge, serviceBridge) {
    ...
    private fun bridgeIsAvailable(): Boolean {
        if (accessBridge == null) {
            ...
            globalAutomator.setService(accessBridge)
    ...
    override fun checkAccessibilityService(): PartialResult {
