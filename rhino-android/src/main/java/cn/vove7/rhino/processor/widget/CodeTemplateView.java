...
import cn.vove7.rhino.processor.Converter;
import cn.vove7.rhino.processor.TypefaceManager;
import cn.vove7.rhino.processor.Wrapper;
...
public class CodeTemplateView extends AppCompatTextView {
    ...
    private Language getLanguage() {
        return new MyJsLanguageWithApi(); //тут у нас может быть только один язык для шаблонов  - ModPE
    }
