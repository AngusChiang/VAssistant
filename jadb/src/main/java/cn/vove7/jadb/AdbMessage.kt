...
import cn.vove7.jadb.AdbProtocol.A_SYNC
...
class AdbMessage(
    ...
    fun toStringShort(): String {
        ...
        return "command=$commandString, arg0=${arg0.hex8()}, arg1=${arg1.hex8()}, data_length=$data_length, data_crc32=$data_crc32, magic=$magic, data=${data?.toHex2()}"
    }

    fun Int.hex8() = toString(16).padStart(8,'0')

    @ExperimentalUnsignedTypes
    fun ByteArray.toHex2(): String {
        var i = 0
        return asUByteArray().joinToString("") {
            it.toString(16).padStart(2, '0') + (if(++i%4==0) " " else "")
        }
    }
