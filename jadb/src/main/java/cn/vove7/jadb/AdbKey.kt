...
class AdbKey(
    ...
    init {
        ...
        this.publicKey = adbKeyStore.getPublicKey() ?: KeyFactory.getInstance("RSA").generatePublic(
            RSAPublicKeySpec(
                privateKey.modulus,
    ...
    private fun getOrCreatePrivateKey(): RSAPrivateKey {
        ...
        var ciphertext = adbKeyStore.getPrivateKey()
        if (ciphertext != null) {
            try {
...
interface AdbKeyStore {
    ...
    fun getPublicKey(): RSAPublicKey? = null
}
