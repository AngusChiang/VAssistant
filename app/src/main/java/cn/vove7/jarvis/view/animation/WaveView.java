...
public class WaveView extends View {
    ...
    private int mSpeed = 600;   // 波纹的创建速度，每500ms创建一个
    ...
    public WaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.WaveView);

        waveColor = arr.getColor(R.styleable.WaveView_waveColor, 0xfff);
        setColor(waveColor);
        arr.recycle();
        start();
    }
