...
class MultiChoiceDialog(context: Context, title: String, list: List<ChoiceData>, val listener: OnMultiSelectListener)
    ...
    class Adapter(context: Context, choiceDataSet: List<ChoiceData>, private val listener: OnMultiSelectListener)
        : BaseListAdapter<Adapter.Holder, ChoiceData>(context, choiceDataSet) {
