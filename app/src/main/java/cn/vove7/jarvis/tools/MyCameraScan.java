 ...
 */
public class MyCameraScan extends CameraScan {
    ...
    public MyCameraScan(@NonNull FragmentActivity activity, @NonNull PreviewView previewView) {
    ...
    public MyCameraScan(@NonNull Fragment fragment, @NonNull PreviewView previewView) {
    ...
    public void startCamera() {
        ...
        mCameraProviderFuture.addListener(() -> {
            ...
            try {
                ...
                //图像分析
                imageAnalysis = mCameraConfig.options(new ImageAnalysis.Builder()
                        .setTargetResolution(mTargetSize)
    ...
    public Size getResolution() {
        return imageAnalysis.getAttachedSurfaceResolution();
    }
