 ...
 *
 * @Override public void handleMessage(Message errMsg) {
 * if (errMsg.what == 100) {
 * AutoCheck autoCheck = (AutoCheck) errMsg.obj;
    ...
    private static class PermissionCheck extends Check {
        ...
        public void check() {
            ...
            for (String perm : permissions) {
                if (!PermissionUtils.INSTANCE.isAllGranted(context, new String[]{perm})) {
