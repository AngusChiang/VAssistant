...
public class MapNode {
   ...
   @Keep
   public MapNode(Long id, String follows) {
      this.id = id;
      this.follows = follows;
   }

   @Keep
   public MapNode(Long id, long actionId, String follows, long paramId) {
      this.id = id;
   ...
   @Keep
   public MapNode(Long id, long actionId, String follows, long paramId, long scopeId) {
      this.id = id;
      this.actionId = actionId;
      this.follows = follows;
      this.paramId = paramId;
   ...
   @Keep
   public MapNode(Long id, long actionId, long paramId, long scopeId) {
      this.id = id;
      this.actionId = actionId;
      this.paramId = paramId;
      this.scopeId = scopeId;
   ...
   @Keep
   public MapNode(Long id, long actionId, long paramId) {
      this.id = id;
      this.actionId = actionId;
      this.paramId = paramId;
   }
   @Keep
   public MapNode(Long id, long actionId) {
      this.id = id;
      this.actionId = actionId;
   }
