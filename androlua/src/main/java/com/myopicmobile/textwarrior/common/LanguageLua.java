...
public class LanguageLua extends Language {
    ...
    private final static String extFunctionTarget = "app|luaman|activity|call|compile|dump|each|enum|import|loadbitmap|loadlayout|loadmenu|set|task|thread|timer";
    private final static String functionTarget = globalTarget + "|" + packageName + "|" + extFunctionTarget;
