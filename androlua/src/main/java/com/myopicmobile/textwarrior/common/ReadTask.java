...
public class ReadTask extends AsyncTask {
    ...
    private FreeScrollingTextField _edit;
    private File _file;
    private long _len;

    public ReadTask(FreeScrollingTextField edit, String fileName) {
        this(edit, new File(fileName));
    }

    public ReadTask(FreeScrollingTextField edit, File file) {
        _file = file;
        _len = _file.length();
        _edit = edit;
